...
namespace NerdStore.Core.DomainObject
{
    public class Validacoes
    {
        ...
        public static void ValidarSeFalso(bool flag, string mensagem)
        {
            if (!flag) throw new DomainException(mensagem);
        }

        public static void ValidarSeVerdadeiro(bool flag, string mensagem)
        {
            if (flag) throw new DomainException(mensagem);
        }
    }
